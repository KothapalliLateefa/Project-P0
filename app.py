...
verbose_name = {
0: 'Abelmoschus sagittifolius used for :Skin beauty, anti-aging. Body purification. Restore health, heal wounds quickly. Blood circulation, prevention of anemia.',
1: 'Abrus precatorius used for:used to treat tetanus, and to prevent rabies.',
2: 'Abutilon indicum useful in gout, tuberculosis, ulcers, bleeding disorders, and worms.',
